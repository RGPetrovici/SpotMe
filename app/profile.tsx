...
export default function ProfileScreen() {
  ...
  // DATOS MOCK: Lo que el usuario NO puede editar directamente
  const USUARIO = {
    nombre: 'Carolina',
    foto: 'https://images.unsplash.com/photo-1581009146145-b5ef050c2e1e?q=80&w=300&auto=format&fit=crop',
    porcentajeCompletado: 75,
    estadoCuenta: 'Excelente', 
    reputacion: ['Puntual ⏱️', 'Máquina de spottear 🛡️', 'Buena vibra 🤙']
  };
    ...
    <SafeAreaView style={styles.safeArea}>
      ...
      <ScrollView style={styles.container} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.topProfileSection}>
          <Image source={{ uri: USUARIO.foto }} style={styles.avatarLarge} />
          <Text style={styles.nameText}>{USUARIO.nombre}</Text>

          {/* BARRA DE PROGRESO TIPO TINDER/HINGE */}
          <View style={styles.progressContainer}>
            <View style={styles.progressHeader}>
              <Text style={styles.progressText}>Perfil al {USUARIO.porcentajeCompletado}%</Text>
              <Text style={styles.progressAction}>Completar</Text>
            </View>
            <View style={styles.progressBarBg}>
              <View style={[styles.progressBarFill, { width: `${USUARIO.porcentajeCompletado}%` }]} />
            </View>
          </View>
        ...
        {/* CÓMO TE VE LA COMUNIDAD (Ahora arriba) */}
        <View style={styles.reputationCard}>
          ...
          <View style={styles.reputationGrid}>
            {USUARIO.reputacion.map((tag, idx) => (
        ...
        {/* ESTADO DE LA CUENTA (Ahora abajo) */}
        <View style={styles.statusCard}>
          <View style={styles.statusRow}>
            ...
            <View style={{flex: 1, marginLeft: 12}}>
              ...
              <Text style={styles.statusValue}>{USUARIO.estadoCuenta}</Text>
            </View>
          </View>
        ...
        <Text style={styles.sectionTitleMain}>TU RED COMPIFIT</Text>
        ...
        {/* RACHA Y TOKENS (Diseño unificado oscuro) */}
...
const styles = StyleSheet.create({
  ...
  // REPUTACIÓN (Ahora con margin 12)
